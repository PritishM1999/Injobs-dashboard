...
const DynamicMetaDetails = () => {
  ...
  return (
    <TabContext.Provider value={{ activeTab }}>
      ...
      {activeTab === "AddMeta" && <AddDynamicMeta />}
      {activeTab === "viewMeta" && <ViewDynamicMeta />}
...
export default DynamicMetaDetails;
